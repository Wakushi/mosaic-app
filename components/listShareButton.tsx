...
const schema = z.object({
  shareAmount: z.number().min(1, { message: "You must list at least one share." }),
            ...
            <div className="space-y-4">
              <div>
                <Input
                  ...
                  type="number"
                />
                {errors.shareAmount && typeof errors.shareAmount.message === "string" && (
                  <p className="text-red-500 text-xs">{errors.shareAmount.message}</p>
                )}
              </div>
              <div>
                <Input
                ...
                {errors.priceUsd && typeof errors.priceUsd.message === "string" && (
                  <p className="text-red-500 text-xs">{errors.priceUsd.message}</p>
                )}
              </div>
