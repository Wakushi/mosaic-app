...
const CreateSharesButton = forwardRef<HTMLDivElement, CreateSharesButtonProps>(({ artwork }, ref) => {
    ...
    <>
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogTrigger asChild>
          <div className='p-1 text-sm cursor-pointer'>Create Shares</div>
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Create Shares</DialogTitle>
            <DialogDescription>Fill in the details to create shares for the artwork.</DialogDescription>
          </DialogHeader>
